...
TEMP_BREACH_OBSERVATION_WINDOW = os.environ.get("TEMP_BREACH_OBSERVATION_WINDOW", 120)
MAX_READING_BREACHES = os.environ.get('MAX_READING_BREACHES', 2)
PROBE_MALFUNCTION_TEMP_VALUE = os.environ.get('PROBE_MALFUNCTION_TEMP_VALUE', 327.67)

TOKEN_USAGE_PER_MESSAGE = 1.876
TOTAL_AVAILABLE_TOKENS = 100_000
